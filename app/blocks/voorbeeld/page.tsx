...
export default function VoorbeeldPage() {
  ...
  return (
    <div className="v2 pb-16">
      ...
      <SlotCtaBand data={{ variant: 'light', compact: true, section: { padding: 'sm' } }} content={{ title: 'Twijfel je welke RF-lens bij je past?', subtitle: 'We denken graag mee.', primary_label: 'Chat met ons', primary_href: '#' }} />
