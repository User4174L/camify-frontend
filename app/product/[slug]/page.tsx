...
const productFaqs: Record<string, FaqItem[]> = {
  'nikon-z8': [
    { q: 'What warranty does a second-hand Nikon Z8 come with?', a: 'Every pre-owned Nikon Z8 sold by Camera-tweedehands.nl includes a 12-month warranty covering manufacturing defects and mechanical failures. This gives you the same peace of mind as buying new.' },
  ...
  'sony-a7-iv': [
    { q: 'What warranty does a second-hand Sony A7 IV come with?', a: 'All pre-owned Sony A7 IV units include a 12-month warranty covering manufacturing defects and mechanical failures.' },
  ...
  'canon-eos-r5': [
    { q: 'What warranty does a second-hand Canon EOS R5 come with?', a: 'Every pre-owned Canon EOS R5 includes a 12-month warranty covering manufacturing defects and mechanical failures.' },
  ...
  'fujifilm-x-t4': [
    { q: 'What warranty does a second-hand Fujifilm X-T4 come with?', a: 'All pre-owned Fujifilm X-T4 units include a 12-month warranty covering manufacturing defects and mechanical failures.' },
  ...
  'sony-fe-24-70mm-f28-gm': [
    { q: 'What warranty does a second-hand Sony 24-70mm GM come with?', a: 'Every pre-owned Sony lens includes a 12-month warranty covering manufacturing defects and mechanical failures.' },
  ...
  'canon-rf-24-70mm-f28-l-is-usm': [
    { q: 'What warranty does a second-hand Canon RF 24-70mm come with?', a: 'All pre-owned Canon lenses include a 12-month warranty covering manufacturing defects and mechanical failures.' },
  ...
  'sony-a7r-v': [
    { q: 'What warranty does a second-hand Sony A7R V come with?', a: 'Every pre-owned Sony A7R V includes a 12-month warranty covering manufacturing defects and mechanical failures.' },
  ...
  'sony-a1': [
    { q: 'What warranty does a second-hand Sony A1 come with?', a: 'All pre-owned Sony A1 units include a 12-month warranty covering manufacturing defects and mechanical failures.' },
  ...
  'nikon-zf': [
    { q: 'What warranty does a second-hand Nikon Zf come with?', a: 'Every pre-owned Nikon Zf includes a 12-month warranty covering manufacturing defects and mechanical failures.' },
  ...
  'dji-mavic-2-pro': [
    { q: 'What warranty does a second-hand DJI Mavic 2 Pro come with?', a: 'All pre-owned DJI drones include a 12-month warranty covering manufacturing defects and mechanical failures.' },
  ...
  'hasselblad-x2d-100c': [
    { q: 'What warranty does a second-hand Hasselblad X2D come with?', a: 'Every pre-owned Hasselblad X2D 100C includes a 12-month warranty covering manufacturing defects and mechanical failures.' },
  ...
  'sony-fe-70-200mm-f28-gm-oss-ii': [
    { q: 'What warranty does a second-hand Sony 70-200mm GM II come with?', a: 'All pre-owned Sony lenses include a 12-month warranty covering manufacturing defects and mechanical failures.' },
...
export default function ProductPage() {
  ...
  const [notifyConditions, setNotifyConditions] = useState<Record<string, boolean>>({ 'As new': true, 'Excellent': true, 'Good': true, 'Fair': false, 'Used': false, 'Heavily used': false });
  ...
  const faqs: FaqItem[] = productFaqs[slug] || [
    { q: `What warranty does a second-hand ${product.title} come with?`, a: `Every pre-owned ${product.title} includes a 12-month warranty covering manufacturing defects and mechanical failures.` },
    { q: 'What\'s the difference between condition grades?', a: '"As New" means virtually no signs of use. "Excellent" shows only minimal cosmetic marks. "Good" may have light wear but is fully functional. "Used" has visible wear that does not affect performance.' },
  ];
      ...
      {isOos ? (
        ...
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32, marginBottom: 48 }}>
            {/* Image */}
            <div style={{ borderRadius: 12, border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '8%', position: 'relative', background: '#fff' }}>
          ...
          {/* USP strip */}
          <div style={{ display: 'flex', gap: 24, padding: '16px 0', borderTop: '1px solid #e5e7eb', marginBottom: 32, fontSize: 13, color: '#6b7280' }}>
            ...
            <span style={{ display: 'flex', alignItems: 'center', gap: 6 }}><svg width="14" height="14" fill="none" stroke="#f97316" strokeWidth="2" viewBox="0 0 24 24"><path d="M3 12a9 9 0 1 0 9-9"/><polyline points="3 3 3 12 9 12"/></svg> 14-day returns</span>
        ...
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 16, marginBottom: 48 }}>
            {filteredVariants.map(v => {
              ...
              return (
                <div key={v.sku} style={{ borderRadius: 12, overflow: 'hidden', background: '#fff', border: '1px solid #e5e7eb', display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div style={{ padding: '12px 14px 14px', display: 'flex', flexDirection: 'column', gap: 4 }}>
                    <span style={{ fontSize: 11, color: '#9ca3af', letterSpacing: '0.02em' }}>SKU: {v.sku}</span>
                    ...
                    {v.shutterCount != null && (
                      <span style={{ fontSize: 12, color: '#9ca3af' }}>Shutter count: {v.shutterCount.toLocaleString('nl-NL')}</span>
                    )}
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        ...
                        <button
                          onClick={() => addItem({ id: v.sku, sku: v.sku, name: product.title, price: v.price, condition: v.conditionLabel, image: product.image, inclVat: v.inclVat ?? false }, product)}
                    ...
                    {expandedAccessories === v.sku && v.accessories && v.accessories.length > 0 && (
                      <ul style={{ margin: '4px 0 0', padding: '0 0 0 18px', fontSize: 12, color: '#6b7280', listStyle: 'disc' }}>
      ...
      {product.specs && (
        <div className="accordion">
          ...
          <div className={`accordion__item${openAccordion === 'shipping' ? ' is-open' : ''}`}>
            ...
            <div className="accordion__body">
              <p>Free shipping on orders above &euro;50 within NL/BE. International shipping available to 10+ EU countries. 14-day no-questions-asked return policy. Items must be returned in the same condition as received.</p>
            </div>
          </div>
        </div>
      )}
