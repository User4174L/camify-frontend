...
const faqData = [
  {
    ...
    items: [
      ...
      { q: 'Wat kost verzending?', a: 'Nederland: gratis vanaf €100, anders €6,95. Overige EU-landen: gratis vanaf €100, anders €17,95. Buiten de EU: gratis vanaf €100, anders €79. Elke bestelling gaat aangetekend en verzekerd de deur uit.' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Hoe stuur ik mijn apparatuur op?', a: 'Na akkoord op je prijsopgave ontvang je een gratis verzendlabel. Verpak je gear goed (bij voorkeur de originele doos plus beschermend materiaal), sluit het pakket zo af dat je kunt zien of iemand het heeft geopend, en lever het af bij een PostNL- of DHL-punt. Bewaar altijd je afgiftebewijs.' },
      { q: 'Is mijn pakket verzekerd als ik iets naar jullie opstuur?', a: 'Ja. Wij leveren het verzendlabel en kiezen de vervoerder, dus het vervoer is ons risico: raakt je pakket onderweg beschadigd of zoek, dan lossen wij dat op. Twee dingen zijn daarvoor nodig. Bewaar je afgiftebewijs, want onze dekking begint op het moment dat de vervoerder het pakket daadwerkelijk heeft ingenomen — een aangemeld label is niet genoeg. En verpak deugdelijk, want schade door gebrekkige verpakking is geen transportschade.' },
      { q: 'Wat als het pakket aankomt met andere inhoud dan afgesproken?', a: 'Wij dekken het vervoer, niet de inhoud. Wij zijn er niet bij als je inpakt en de vervoerder controleert niet wat erin zit, dus jij bent er verantwoordelijk voor dat je verstuurt wat je hebt opgegeven. Komt een pakket ongeschonden en zonder sporen van opening bij ons aan, maar zit er iets anders in dan in de offerte staat, dan is er geen transportschade en komt er geen koop tot stand. Wij openen elk pakket onder toezicht en leggen de staat van de verpakking vast.' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Hoe bereik ik de klantenservice?', a: 'Per e-mail via klantenservice@camera-tweedehands.nl, telefonisch op 085 301 83 32 (ma–vr 09:00–16:30, za 09:00–16:00 op afspraak) of via de live chat op de website. Op e-mail antwoorden we meestal binnen 1–2 werkdagen, uiterlijk binnen 7.' },
    ],
  },
];
