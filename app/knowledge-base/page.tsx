...
const kbTopics: KBArticle[] = [
  ...
  },
  {
    ...
    tags: ['Guide', 'Buying'],
    content: [
      'When you buy a used camera, condition grading is everything. But vague labels like "good" or "excellent" can mean different things depending on who\'s selling. At Camera-tweedehands.nl, we use a standardized five-tier grading system so you always know exactly what to expect. Every grade is backed by real product photos showing the actual item you\'ll receive.',
  ...
  },
  {
    ...
    content: [
      'This is one of the most common questions we get at Camera-tweedehands.nl, and the honest answer is: it depends on what you shoot and how you shoot it. Both mirrorless and DSLR cameras can produce stunning images — the "best" choice is really about which trade-offs matter most to you. Let\'s break it down.',
  ...
  },
  {
    ...
    content: [
      ...
      'When shopping in this price range, pay attention to shutter count (aim for under 50,000 for the best longevity), check for sensor dust or scratches, and make sure all buttons, dials, and ports work. At Camera-tweedehands.nl, we test and grade every camera thoroughly, so you can buy with confidence. Any of these cameras will serve you well for years to come.',
    ],
  },
  {
    ...
    content: [
      ...
      'Finally, check the physical condition. Rotate the zoom and focus rings — they should be smooth with no catching or excessive looseness. Inspect the mount for signs of wear or cross-threading. Look at the contacts (the gold pins on the mount) for corrosion or scratches. Check that the filter thread isn\'t dented, as this can make it impossible to attach filters. At Camera-tweedehands.nl, we document all of this in our product listings with real photos and detailed condition notes, so you can make an informed decision.',
    ],
  },
  {
    id: 'sensor-sizes',
  ...
  },
  {
    ...
    tags: ['Tips', 'Buying'],
    content: [
      'Buying a used camera doesn\'t have to be risky — you just need to know what to look for. Whether you\'re buying from Camera-tweedehands.nl (where we do these checks for you) or elsewhere, here are the five most important things to verify before spending your money.',
