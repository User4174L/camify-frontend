...
export const products: Product[] = [
  {
    ...
    variants: [
      ...
      { sku: '257999', price: 1649, condition: 'good', conditionLabel: 'Good', shutterCount: 34200, cosmeticRemark: 'Light wear marks on the top plate and bottom plate. Fully functional.', sensorCleaned: true, firmwareVersion: '1.06', boxIncluded: false, accessories: ['Body cap', 'Battery NP-FZ100'], images: ['/images/sony-a7-iv.jpg'], inclVat: true, badges: ['outlet', 'vat'], previousPrice: 1749, priceDroppedAt: daysAgo(3) },
      ...
      { sku: '258045', price: 1399, condition: 'used', conditionLabel: 'Used', shutterCount: 89000, cosmeticRemark: 'Heavy use visible. Brassing on edges, grip wear. Fully functional.', sensorCleaned: true, firmwareVersion: '1.06', boxIncluded: false, accessories: ['Body cap'], images: ['/images/sony-a7-iv.jpg'], previousPrice: 1529, priceDroppedAt: daysAgo(5) },
    ],
  ...
  },
  {
    ...
    stock: 2,
    image: '/images/nikon-z8.jpg',
    description: '24.2MP APS-C DSLR — testcase voor SKU-zoeken (23200 / 21030)',
    variants: [
      { sku: '23200', price: 279, condition: 'excellent', conditionLabel: 'Excellent', shutterCount: 14200, sensorCleaned: true, boxIncluded: false, accessories: ['Body cap', 'Battery EN-EL14', 'Charger'], images: ['/images/nikon-z8.jpg'], inclVat: false },
      { sku: '21030', price: 249, condition: 'good', conditionLabel: 'Good', shutterCount: 30900, cosmeticRemark: 'Lichte gebruikssporen op de grip.', sensorCleaned: true, boxIncluded: false, accessories: ['Body cap', 'Battery EN-EL14'], images: ['/images/nikon-z8.jpg'] },
    ],
    specs: { 'Sensor': '24.2MP APS-C CMOS', 'Mount': 'Nikon F', 'ISO Range': '100-6400', 'Video': '1080p 30p', 'Weight': '505g', 'Year': '2012' },
  },
  {
    id: '11',
